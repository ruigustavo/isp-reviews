...
const ratingOptions = [5,4,3,2,1].map((score, index) =>{
    return (
        <Fragment>
            <input type="radio" value={score} checked={props.review.score == score} name="score" onChange={() => console.log('selected', score)} id={`rating-${score}`} />
    ...
    return(
        <Wrapper>
            <form onSubmit={props.handleSubmit}>
                ...
                <Field>
                    <RatingContainer>
                        <RatingTitle>Rate this Internet Provider</RatingTitle>
                        <RatingBox>
                            {ratingOptions}
                        </RatingBox>
                    </RatingContainer>
